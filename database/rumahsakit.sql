...
--
-- Host: localhost
-- Waktu pembuatan: 01 Apr 2020 pada 04.37
-- Versi server: 8.0.18
-- Versi PHP: 7.3.11
...
(2, 'Bella Hesty', 'Kota Batu', '09878767766', 'Dokter Otak'),
(5, 'Sabrina Eka', 'Jl Piranha Atas', '082228773286', 'THT'),
(11, 'Irma Laela', 'Jl Bululawang', '08923572676', 'Dokter Mata'),
(12, 'Inayati', 'Probolinggo', '087888765678', 'Dokter Gigi'),
(15, 'Budi Utomo', 'Malang', '081234567890', 'Dokter Syaraf');
...
(1, 'paracetamol', 'sirup', 8),
(3, 'Ultraflu', 'Tablet', 10),
(5, 'Insto', 'Obat Tetes', 13),
(6, 'Mylanta', 'Tablet', 10);
...
CREATE TABLE `periksa` (
  ...
  `keluhan` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(1, 7, 1, 'Demam', '2020-03-11'),
(2, 6, 1, 'Pusing', '2020-03-14'),
(3, 5, 5, 'Pusingg', '2020-03-03'),
(4, 5, 11, 'Sakit Mata', '2020-03-27');
...
(1, 5, 4, 15, 5, 25000, '2020-03-11'),
(2, 5, 2, 1, 3, 30000, '2020-03-14'),
(8, 7, 1, 1, 1, 15000, '2020-03-27'),
(9, 6, 2, 1, 1, 25000, '2020-03-28');
...
(7, 'Milan', 'Millan', 'milan@gmail.com', '49e34051a5bb3df733080908649b9ad1', 'user', 'Aktif');
...
--
ALTER TABLE `dokter`
  MODIFY `id_dok` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `periksa`
  MODIFY `id_periksa` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
